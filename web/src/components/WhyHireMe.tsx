    ...
    <SectionWrapper id="hire" className="bg-gray-50/70 overflow-visible">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
        <div className="lg:col-span-5">
          <span className="text-blue-600 font-bold tracking-wider text-xs block mb-6">
            Why Work With Me
          </span>
          ...
          <p className="text-lg text-gray-600 font-medium leading-relaxed max-w-xl">
            I combine WordPress development, performance optimization, and
            community leadership to deliver results fast. My work turns slow,
            outdated websites into fast, secure platforms that actually support
            business growth.
          </p>
        </div>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-4">
          {reasons.map((reason, index) => (
            <GlassCard
              key={reason}
              className="p-5 sm:p-6 border border-gray-100 hover:border-blue-200 transition-all"
            >
