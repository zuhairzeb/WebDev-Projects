...
const experiences = [
  {
    ...
    location: "Remote",
    type: "work",
    description: "Completed a hands-on WordPress training program covering 45+ practical tasks across a live institute website. Configured on-page SEO, structured navigation and dropdown menus, managed theme setup and branding, handled media library workflows, performed pre-launch QA checks, and documented site migration and backup procedures.",
    tags: ["WordPress", "SEO", "Theme Setup", "Media Management", "QA", "Site Security"],
  },
  {
  ...
  },
  {
    ...
    company: "DOSTI Welfare Organization (DWO)",
    location: "Remote / Pakistan",
    type: "volunteer",
    description: "Contributed to community welfare and social support initiatives, helping strengthen outreach and emergency response efforts for underserved communities.",
    tags: ["Community Support", "Social Impact", "Outreach", "Volunteerism"],
  },
  {
    ...
    location: "Remote / Pakistan",
    type: "volunteer",
    description: "Supported community-focused initiatives and child welfare programs through volunteer participation, helping improve outreach and humanitarian support efforts.",
    tags: ["Humanitarian Work", "Community Outreach", "Support Programs", "Volunteer"],
  },
  {
    year: "Oct 2020 – Jan 2024",
    title: "Emergency Preparedness Coordinator",
    company: "World Health Organization",
    location: "Remote / Global",
    type: "volunteer",
    description: "Coordinated emergency readiness activities, supported preparedness planning, and contributed to public health awareness efforts focused on building resilience in communities.",
    tags: ["Emergency Planning", "Preparedness", "Public Health", "Coordination"],
  },
  {
    year: "Aug 2025",
