...
var Query = (_a5 = class extends Removable {
  ...
  async fetch(options, fetchOptions) {
    var _a13, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k;
...
var _client5, _result, _queries, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _lastQueryHashes, _observerMatches, _QueriesObserver_instances, trackResult_fn, combineResult_fn, shouldSkipCombine_fn, findMatchingObservers_fn, onUpdate_fn, notify_fn3, _a10;
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  var _a13;
  return ((_a13 = __privateGet(this, _options)) == null ? void 0 : _a13.combine) !== void 0 && __privateGet(this, _observers2).some((observer, index) => {
    var _a14;
    return observer.options.suspense && ((_a14 = __privateGet(this, _result)[index]) == null ? void 0 : _a14.data) === void 0;
  });
  ...
  if (this.hasListeners()) {
    ...
    const newResult = shouldSkipCombine ? previousResult : __privateMethod(this, _QueriesObserver_instances, combineResult_fn).call(this, newTracked, (_a13 = __privateGet(this, _options)) == null ? void 0 : _a13.combine);
